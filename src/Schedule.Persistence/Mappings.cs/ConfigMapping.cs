...
internal class ConfigMapping : IEntityTypeConfiguration<Config>
{
    public void Configure(EntityTypeBuilder<Config> builder)
    {
        ...
        (
            ...
            new Config() { CronMaskId = 1, MarketId = 1, CompanyTypeId = null },
            new Config() { CronMaskId = 2, MarketId = 1, CompanyTypeId = null },
            new Config() { CronMaskId = 4, MarketId = 1, CompanyTypeId = null },
            new Config() { CronMaskId = 6, MarketId = 1, CompanyTypeId = null },
            new Config() { CronMaskId = 7, MarketId = 1, CompanyTypeId = null },
            // Norway: 4 notifications (sent on days: 1, 5, 10, 20), all company types
            new Config() { CronMaskId = 1, MarketId = 2, CompanyTypeId = null },
            new Config() { CronMaskId = 2, MarketId = 2, CompanyTypeId = null },
            new Config() { CronMaskId = 4, MarketId = 2, CompanyTypeId = null },
            new Config() { CronMaskId = 7, MarketId = 2, CompanyTypeId = null },
            // Sweden: 4 notifications (sent on days: 1, 7, 14, 28), only for small and medium companies
            new Config() { CronMaskId = 1, MarketId = 3, CompanyTypeId = 1 },
            new Config() { CronMaskId = 3, MarketId = 3, CompanyTypeId = 1 },
            new Config() { CronMaskId = 5, MarketId = 3, CompanyTypeId = 1 },
            new Config() { CronMaskId = 8, MarketId = 3, CompanyTypeId = 1 },
            ...
            new Config() { CronMaskId = 1, MarketId = 4, CompanyTypeId = 3 },
            new Config() { CronMaskId = 2, MarketId = 4, CompanyTypeId = 3 },
            new Config() { CronMaskId = 4, MarketId = 4, CompanyTypeId = 3 },
            new Config() { CronMaskId = 6, MarketId = 4, CompanyTypeId = 3 },
            new Config() { CronMaskId = 7, MarketId = 4, CompanyTypeId = 3 }
        );
    }
}