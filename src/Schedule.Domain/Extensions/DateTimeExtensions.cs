...
public static class DateTimeExtensions
{
    ...
    {
        var lower = new DateTime(seed.Year, seed.Month, 1, 0, 0, 0).AddTicks(-1);
        var upper = new DateTime(seed.Year, seed.Month + 1, 1, 0, 0, 0);
    ...
    public static string ToFormattedDate(this int timestamp)
    {
        ...
        var result = datetime.ToString(DATE_FORMAT);
        return result;
    }
}